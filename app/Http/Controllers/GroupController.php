...
class GroupController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'form_of_education' => 'required|string|starts_with:бакалавриат,специалитет,магистратура',
        ]);
    ...
    public function update(Request $request, $id)
    {
        $request->validate([
            ...
            'form_of_education' => 'string|starts_with:бакалавриат,специалитет,магистратура',
        ]);
